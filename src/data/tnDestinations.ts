...
const rawDestinations: TNDestination[] = [
  ...
  },
  {
    "id": "dhanushkodi",
    "name": "Dhanushkodi",
    "fullName": "Dhanushkodi (Heritage Coast)",
    "category": "beach",
    "emoji": "🏛️",
    "district": "Ramanathapuram",
    "description": "India's last village. Destroyed by 1964 cyclone. Two seas visible simultaneously. Historic town ruins, pristine beaches. Hauntingly beautiful.",
    "attractions": [
      "Historic Town Ruins 🏛️",
      "Two-Sea Beach 🌊",
  ...
  },
  {
    ...
    "fullName": "Gangaikonda Cholapuram Chola Temple",
    "category": "heritage",
    "emoji": "🛕",
    "district": "Ariyalur",
  ...
  },
  {
    "id": "karaikudi",
    "name": "Karaikudi",
    "fullName": "Karaikudi (Chettinad Heritage Hub)",
    "category": "heritage",
    "emoji": "🛕",
    "district": "Sivaganga",
  ...
  },
  {
    "id": "chettinad",
    "name": "Chettinad",
    "fullName": "Chettinad Mansions Region",
    "category": "heritage",
    "emoji": "🛕",
    "district": "Sivaganga",
  ...
  },
  {
    "id": "gingee-fort",
    "name": "Gingee Fort",
    "fullName": "Gingee Fort (Troy of the East)",
    "category": "heritage",
    "emoji": "🏰",
    "district": "Villupuram",
    "description": "Impregnable hilltop fortress complex built by Cholas and expanded by Vijayanagara Kings, Nayaks, and Marathas. Dubbed 'Troy of the East' by the British.",
    "attractions": [
      "Rajagiri Citadel Hill 🏰",
      "Krishnagiri Fort ⛰️",
      "Kalyana Mahal 7-Storey Tower 🕌",
      "Royal Granaries & Stables 🏛️",
      "Venkataramana Temple 🛕",
      "Ranganathar Cave Shrine 🕉️",
      "Royal Moat & Bridge 💧",
      "Chakrakulam Pond 🌊",
      "Gymnasium Hall 🏋️‍♂️",
      "Prisoners Cell & Watchtower 🔑"
    ],
    "nearestStation": "villupuram Junction",
    "hasRailAccess": false,
    "lat": 12.251,
    "lng": 79.418
  },
  {
    "id": "pudukkottai",
    "name": "Pudukkottai",
    "fullName": "Pudukkottai Heritage Town & Royal Palace",
    "category": "heritage",
    "emoji": "🏛️",
    "district": "Pudukkottai",
    "description": "Historic princely state kingdom renowned for royal palaces, ancient museums, rock-cut Jain & Chola monuments, and megalithic burial sites.",
    "attractions": [
      "Pudukkottai Royal Palace 👑",
      "Government Museum Pudukkottai 📜",
      "Brahadambal Temple & Tank 🛕",
      "Thirumayam Fort Day Trip 🏰",
      "Sittannavasal Cave Murals 🎨",
      "Kudumiyanmalai Music Inscription Cave 🎶",
      "Avur Church Heritage Site ⛪",
      "Narthamalai Chola Cave Temple 🗿",
      "Porpanaikottai Fort Ruins 🧱",
      "Kunnandarkoil Rock Cave 🪨"
    ],
    "nearestStation": "Pudukkottai",
    "hasRailAccess": true,
    "lat": 10.383,
    "lng": 78.821
  },
  {
    "id": "sittannavasal",
    "name": "Sittannavasal",
    "fullName": "Sittannavasal Rock-Cut Caves & Monolithic Beds",
    "category": "heritage",
    "emoji": "🎨",
    "district": "Pudukkottai",
    "description": "World-famous 2nd-century BCE Jain heritage site featuring exquisite Lotus Pond fresco wall paintings, rock-cut Arivar Koil cave, and ancient stone beds.",
    "attractions": [
      "Lotus Pond Fresco Paintings 🎨",
      "Arivar Koil Rock-Cut Cave 🛕",
      "Ezhadippattam Jain Stone Beds 🪨",
      "Natural Echo Cavern 🔊",
      "Archaeological Park & Walkway 🌿",
      "Thirumayam Fort Circuit 🛡️",
      "Navagriha Relief Sculptures 🗿",
      "Ancient Tamil-Brahmi Inscriptions 📜",
      "Samandar Hilltop Viewpoint ⛰️",
      "Kudumiyanmalai Rock Temple 🛕"
    ],
    "nearestStation": "Pudukkottai",
    "hasRailAccess": false,
    "lat": 10.457,
  ...
  },
  {
    "id": "thirumayam",
    "name": "Thirumayam",
    "fullName": "Thirumayam Rock Fort & Cave Temples",
    "category": "heritage",
    "emoji": "🛡️",
    "district": "Pudukkottai",
    "description": "Historic 17th-century fortress built by Vijaya Raghunatha Sethupathi, famous for its massive ring wall and twin rock-cut Shiva & Vishnu cave shrines.",
    "attractions": [
      "Thirumayam Hilltop Rock Fort 🏰",
      "Cave Vishnu Temple (Adhi Meyyappar) 🕉️",
      "Cave Satyagiriswarar Shiva Temple 🛕",
      "Rampart Cannon Points 💣",
      "Rock Inscriptions & Carvings 📜",
      "Fort Moat Walkway 🌊",
      "Poligar War History Display ⚔️",
      "Kottai Vinayagar Shrine 🐘",
      "Sittannavasal Day Route 🎨",
      "Pudukkottai Museum Access 🏛️"
    ],
    "nearestStation": "Pudhukootai",
    "hasRailAccess": true,
    "lat": 10.247,
    "lng": 78.749
  },
  {
    ...
    "fullName": "Panchalankurichi Fort (Veerapandiya Kattabomman Memorial)",
    "category": "heritage",
    "emoji": "⚔️",
    "district": "Thoothukudi",
    "description": "The historic citadel of freedom fighter Veerapandiya Kattabomman who revolted against East India Company. Features reconstructed fort walls and war museum.",
    "attractions": [
      "Kattabomman Memorial Fort Complex 🏰",
      "Historical Freedom Struggle Museum 📜",
      "Statue of Veerapandiya Kattabomman 🗿",
      "Jakka Devi Temple 🛕",
      "British Battery Siege Site 💣",
      "Kayathar Kattabomman Memorial Tree 🌳",
      "Ottapidaram V.O.C. House 🏠",
      "Ettayapuram Bharatiyar Memorial ✍️",
      "Maniyachi Junction Memorial 🚉",
      "Thoothukudi Coast Side Trip 🌊"
    ],
    "nearestStation": "Kovilpatti",
    "hasRailAccess": false,
    "lat": 8.908,
    "lng": 77.969
  },
  {
    "id": "udayagiri-fort",
    "name": "Udayagiri Fort",
    "fullName": "Udayagiri Fort & De Lannoy's Tomb",
    "category": "heritage",
    "emoji": "🏰",
    "district": "Kanyakumari",
    "description": "17th-century Travancore kingdom granite fort re-engineered by Flemish commander Eustachius De Lannoy. Surrounded by massive walls and bio-park.",
    "attractions": [
      "Granite Ramparts & Moat 🏰",
      "Eustachius De Lannoy's Tomb 🪦",
      "Udayagiri Deer & Biodiversity Park 🦌",
      "Foundry & Cannon Battery 💣",
      "Palace Watchtower Ruins 👁️",
      "Padmanabhapuram Palace Side Trip 🪵",
      "Thiruvithamcode Arapally Church ⛪",
      "Mathur Aqueduct 🌉",
      "Chitharal Jain Monuments 🗿",
      "Nagercoil Heritage Belt 🏛️"
    ],
    "nearestStation": "Eraniel/Nagercoil Junction",
    "hasRailAccess": true,
    "lat": 8.249,
    "lng": 77.332
  },
  {
    ...
    "fullName": "Padmanabhapuram Wooden Palace (Venad Kingdom Citadel)",
    "category": "heritage",
    "emoji": "🪵",
    "district": "Kanyakumari",
    "description": "Magnificent 16th-century wooden palace of the Travancore Maharajas, a architectural masterpiece of intricate timber carving and polished black egg-shell floors.",
    "attractions": [
      "King's Council Chamber (Mantrasala) 👑",
      "Thai Kottaram (Queen Mother's Palace) 🏛️",
      "Navarathri Mandapam Performance Hall 💃",
      "Ancient Clock Tower ⏰",
      "Royal Treasury & Weaponry Museum 🗡️",
      "Belgian Mirror & Mahogany Gallery 🪞",
      "Udayagiri Fort Side Trip 🏰",
      "Mathur Hanging Trough Bridge 🌉",
      "Thirparappu Waterfalls Route 💦",
      "Kanyakumari Beach Circuit 🏖️"
    ],
    "nearestStation": "Nagercoil Junction",
    "hasRailAccess": false,
    "lat": 8.251,
  ...
  },
  {
    "id": "keezhadi",
    "name": "Keezhadi",
    "fullName": "Keezhadi Sangam Era Archaeological Site & Museum",
    "category": "heritage",
    "emoji": "🏺",
    "district": "Sivaganga",
    "description": "Epoch-making 6th-century BCE Vaigai River Valley Sangam civilization excavation site, featuring a state-of-the-art site museum with Tamil antiquity artifacts.",
    "attractions": [
      "Keezhadi Heritage Site Museum 🏛️",
      "Excavated Brick Structures & Ring Wells 🧱",
      "Tamil-Brahmi Inscribed Pottery 🏺",
      "Carnelian Beads & Ivory Board Games 🎲",
      "Weaving & Metal Craft Displays 🧵",
      "Madurai Meenakshi Temple Route 🛕",
      "Thirumalai Nayakar Mahal Side Trip 👑",
      "Sivaganga Palace Circuit 🏰",
      "Kondagai Burial Site Museum ⚱️",
      "Agaram Excavation Zone ⛏️"
    ],
    "nearestStation": "Madurai Junction",
    "hasRailAccess": false,
    "lat": 9.863,
  ...
  },
  {
    "id": "kazhugumalai",
    "name": "Kazhugumalai",
    "fullName": "Kazhugumalai Rock-Cut Temples & Jain Bas-Reliefs",
    "category": "heritage",
    "emoji": "🗿",
    "district": "Thoothukudi",
    "description": "Renowned as the 'Ellora of the South', home to 8th-century monolithic Pandya Vettuvan Koil temple and breathtaking cliffside Jain Tirthankara relief carvings.",
    "attractions": [
      "Vettuvan Koil Monolithic Rock Temple 🛕",
      "Jain Rock-Cut Bas-Relief Sculptures 🗿",
      "Kazhugasathiamoorthy Murugan Cave Shrine 🛕",
      "Vattam Rock Formations 🪨",
      "Ancient Vatteluttu Rock Inscriptions 📜",
      "Sankarankoil Temple Circuit 🕉️",
      "Kovilpatti Town Base 🏙️",
      "Ettayapuram Cultural Walk ✍️",
      "Panchalankurichi Freedom Fort 🏰",
      "Tirunelveli Heritage Route 🏛️"
    ],
    "nearestStation": "Kovilpatti",
    "hasRailAccess": false,
    "lat": 9.143,
  ...
  },
  {
    ...
    "name": "Tirumalai Nayakar Mahal",
    "fullName": "Tirumalai Nayakar Palace & Heritage Complex",
    "category": "heritage",
    "emoji": "👑",
    "district": "Madurai",
    "description": "1636 CE architectural marvel built by King Tirumalai Nayak in Indo-Saracenic style, famous for giant stucco pillars, celestial hall, and sound & light show.",
    "attractions": [
      "Swarga Vilasam (Celestial Pavilion) 🏛️",
      "Giant Stucco Pillars (82 ft tall) 🏛️",
      "Royal Courtyard & Throne Room 👑",
      "Nightly Sound & Light Show 🎆",
      "ASI Archaeological Museum 📜",
      "Meenakshi Amman Temple Walk 🛕",
      "Koodal Azhagar Temple Route 🕉️",
      "Madurai Teppakulam Lake 💧",
      "Keezhadi Museum Day Trip 🏺",
      "Gandhi Memorial Museum 🕊️"
    ],
    "nearestStation": "Madurai Junction",
    "hasRailAccess": true,
    "lat": 9.915,
  ...
  },
  {
    ...
    "fullName": "Sadras Historic Dutch Coastal Fort",
    "category": "heritage",
    "emoji": "⚓",
    "district": "Chengalpattu",
    "description": "17th-century coastal fortress built by the Dutch East India Company. Features brick ramparts, Dutch cemetery, granary, secret passages, and ancient bell tower.",
    "attractions": [
      "Dutch Fort Ramparts & Bastions 🏰",
      "Historical Dutch Cemetery (1600s) 🪦",
      "Brick Granary & Ordnance Store 🏛️",
      "Historic Watchtower & Bell Tower 🔔",
      "Sadras Beach & Fishing Harbor 🌊",
      "Alamparai Fort Coastal Route 🏰",
      "Mahabalipuram UNESCO Circuit 🗿",
      "Kalpakkam Coastal Belt 🏖️",
      "ECR Scenic Drive 🚗",
      "Sadras Shiva Temple 🛕"
    ],
    "nearestStation": "Chengalpattu Junction",
  ...
  },
  {
    "id": "alamparai-fort",
    "name": "Alamparai Fort",
    "fullName": "Alamparai Seaside Fort & Ruins",
    "category": "heritage",
    "emoji": "🏰",
    "district": "Chengalpattu",
    "description": "Picturesque 18th-century Mughal & Carnatic fort ruins standing directly on backwaters and the Bay of Bengal, built with red brick masonry and palm groves.",
    "attractions": [
      "Seaside Red-Brick Ramparts 🏰",
      "Backwater Boating & Fishermen Dock 🚣",
      "Ruined Watchtowers & Barracks 🧱",
      "Coastal Beach Viewpoint 🏖️",
      "Sunset Point on ECR Backwaters 🌅",
      "Sadras Dutch Fort Circuit ⚓",
      "Marakkanam Salt Pans 🧂",
      "Pondicherry ECR Route 🇫🇷",
      "Tindivanam Heritage Base 🏙️",
      "Mudaliarkuppam Boat House 🚤"
    ],
    "nearestStation": "Melmaruvathur",
    "hasRailAccess": false,
    "lat": 12.259,
    "lng": 79.992
  },
  {
    "id": "kanadukathan",
    "name": "Kanadukathan",
    "fullName": "Kanadukathan Chettinad Palace Village",
    "category": "heritage",
    "emoji": "🏰",
    "district": "Sivaganga",
    "description": "The grand heartland of Chettinad heritage, famous for the iconic 1912 Chettinad Palace, marble courtyards, Burmese teak pillars, and handmade Athangudi tiles.",
    "attractions": [
      "Chettinad Palace Kanadukathan 🏰",
      "Thousand Window House 🪟",
      "Traditional Mansion Street Walk 🚶‍♂️",
      "Athangudi Handmade Tile Palace Workshop 🎨",
      "Chettinad Antique Furniture Market 🏺",
      "Pillayarpatti Temple Route 🐘",
      "Karpaga Vinayagar Cave Shrine 🛕",
      "Chettinad Cuisine Tasting 🍛",
      "Kottaiyur Heritage Mansions 🏛️",
      "Karaikudi Heritage Junction 🚉"
    ],
    "nearestStation": "Karaikudi Junction",
    "hasRailAccess": true,
    "lat": 10.174,
